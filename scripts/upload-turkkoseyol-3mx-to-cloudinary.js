/**
 * public/01_20251124_TurkkoseYol_3MXWeb klasörünü Cloudinary'de
 * Pusula/01_20251124_TurkkoseYol_3MXWeb altına yükler.
 * Sadece Cloudinary'de olmayan (eksik) dosyaları yükler.
 * Kullanım: node scripts/upload-turkkoseyol-3mx-to-cloudinary.js
...
const CLOUDINARY_FOLDER = 'Pusula/01_20251124_TurkkoseYol_3MXWeb';
const LOCAL_DIR = path.join(process.cwd(), 'public', '01_20251124_TurkkoseYol_3MXWeb');
